...
ab.Text="Remaing In Game(20Minuites till next Anti Kick)!"wait(2)ab.Text="Status: Active"end)se = Instance.new("TextButton")
...
SnowyShiro.Text = "Eddited By KimDog"
...
Name.Text = "CheaterSoul Remastered By KimDog"
